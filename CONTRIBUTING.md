...
Please do not submit patches, issue reports, comments, or any other material
generated by a large language model. Doing this shows a profound disrespect
for the maintainers' time and ignores the many harms that such systems inflict
on society. Violators will get one warning followed by a ban on the second
offense.

Any use of this project's code by a large language model, past or present,
is done without the permission of its authors. We do not consent to use of
this project's data in training any such model.
